...
if (isset($_POST["submitted"])==1 && $_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $dat = $obj->updateAnggota($id,$kelompok,$nama,$nomor_anggota);
    $msg = getJSON($dat);
}
                        ...
                        <div class="body table-responsive">
                            <div class="panel panel-default">
                                ...
                                ?>
                                            ...
                                            <h2><strong>Anggota</strong> <small>Edit Data</small> </h2>
                                            </div>
                                            ...
                                            <form name="formEdit" method="POST" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <option value="<?php echo $row['kelompok']; ?>">
                                                    <?php echo $row['kelompok']; ?></option>
