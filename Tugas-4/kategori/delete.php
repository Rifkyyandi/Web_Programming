                            ...
                            <div class="panel panel-default">
                                <div class="panel-body" id="primary-content">
                                            ...
                                            if($msg===true){ 
                                                ...
                                                echo '<meta http-equiv="refresh" content="3;url='.base_url().'kategori/">';
                                            } elseif($msg===false) {
                                            ...
                                            <h2><strong>KATEGORI</strong> <small>Delete Data</small> </h2>
                                            </div>
                                            <hr/>
                                            <form name="formDelete" method="POST" action="">
                                                ...
                                                <dt class="col-sm-3">kode:</dt><dd class="col-sm-9"><?php echo $row['kode']; ?></dd>
